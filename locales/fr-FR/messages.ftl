...
failed-to-sign-check-your-gpg-keys = Échec de la signature cryptographique du manifeste. Vérifiez vos clés GPG.
...
src-must-be-contains-uvd-yml = Le répertoire source doit contenir un fichier uvd.yml.

# Extraction
developer-files-extracted-successfully = Les fichiers du développeur ont été extraits avec succès.
reviewer-files-extracted-successfully = Les fichiers du reviewer ont été extraits avec succès.
...
who-are-your-manager = Sélectionnez le Manager assigné :
submit-cancelled = Opération annulée par l'utilisateur.
archive-not-found = Le paquet de l'archive n'a pas pu être trouvé.
